...
pub fn main() anyerror!void {
    ...
    var tarball_path_buf: bun.PathBuffer = std.mem.zeroes(bun.PathBuffer);
    ...
    if (safe.SimdUtils.eql(std.fs.path.extension(tarball_path), ".gz") or safe.SimdUtils.eql(std.fs.path.extension(tarball_path), ".tgz")) {
