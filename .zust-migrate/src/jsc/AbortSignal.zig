pub const AbortSignal = opaque {
    ...
    pub fn listen(
        ...
        const Wrapper = struct {
            ...
            pub fn callback(
                ...
                const val = bun.cast(*Context, if (ptr) |value| {
    value
} else {
    return error.NullPointer;
        ...
        return this.addListener(@as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ctx)), Wrapper.callback);
    }
