pub const JSCell = opaque {
    ...
    pub fn getGetterSetter(this: *JSCell) *GetterSetter {
        ...
        return @as(*GetterSetter, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    ...
    pub fn getCustomGetterSetter(this: *JSCell) *CustomGetterSetter {
        ...
        return @as(*CustomGetterSetter, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(this)));
    }
