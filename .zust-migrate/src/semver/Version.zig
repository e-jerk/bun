...
var loop_limit: usize = 0;
                    ...
                    const lhs_uint: ?IntType = std.fmt.parseUnsigned(IntType, (if (lhs_part) |value| {
    value
} else {
    return error.NullPointer;
}), 10) catch null;
                    const rhs_uint: ?IntType = std.fmt.parseUnsigned(IntType, (if (rhs_part) |value| {
    value
} else {
    return error.NullPointer;
}), 10) catch null;
                    ...
                    if (lhs_uint == null and rhs_uint == null) {
                        switch (strings.order((if (lhs_part) |value| {
    value
} else {
    return error.NullPointer;
}), (if (rhs_part) |value| {
    ...
    return error.NullPointer;
                    ...
                    switch (std.math.order((if (lhs_uint) |value| {
    value
} else {
    return error.NullPointer;
}), (if (rhs_uint) |value| {
