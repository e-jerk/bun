...
// safe-transpile: function uses raw slice parameter — consider safe.String
    ...
    pub const AsyncFormData = struct {
        ...
        pub fn init(allocator: std.mem.Allocator, encoding: Encoding) !*AsyncFormData {
            const this = try safe.Box(AsyncFormData).init(allocator, undefined);
            this[0] = AsyncFormData{
...
// safe-transpile: function uses raw slice parameter — consider safe.String
    pub fn toJSFromMultipartData(
        ...
        const form_data_value = safe.Box(globalThis).init(allocator, undefined);
...
// safe-transpile: function uses raw slice parameter — consider safe.String
            pub fn onEntry(wrap: *@This(), name: bun.Semver.String, field: Field, buf: []const u8) void {
                ...
                if (field.is_file) {
                    ...
                    const content_type: safe.Slice(u8) = brk: {
...
// safe-transpile: function uses raw slice parameter — consider safe.String
    pub fn forEachMultipartEntry(
        ...
        var buf: [76]u8 = .{};
        {
            ...
            slice = slice[0..if (final_boundary_index) |value| {
    value
} else {
