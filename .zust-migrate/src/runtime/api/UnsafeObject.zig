...
pub fn arrayBufferToString(
    ...
    switch (array_buffer.typed_array_type) {
        .Uint16Array, .Int16Array => {
            ...
            zig_str._unsafe_ptr_do_not_use = @as([*]const u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(array_buffer.ptr)));
