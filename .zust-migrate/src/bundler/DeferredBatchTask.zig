...
pub fn getBundleV2(this: *DeferredBatchTask) *bun.BundleV2 {
    ...
    @alignCast(@fieldParentPtr("drain_defer_task", this));
}
...
pub fn schedule(this: *DeferredBatchTask) void {
    ...
    this.getBundleV2().jsLoopForPlugins().enqueueTaskConcurrent(safe.Box(jsc.Task.init(this)).init(allocator, undefined));
}
