        ...
        while (i != 0) {
            ...
            switch (entry.kind) {
                ...
                .external_path => |*p| {
                    ...
                    if (entry.conditions.len > 0) {
                        ...
                        while (j != 1) {
                            ...
                            p[0] = bun.fs.Path.init(DataURL.encodeStringAsShortestDataURL(allocator, "text/css", std.mem.trim(u8, print_result.code, " \n\r\t")));
                        }
                    }
                ...
                .source_index => |source_index| {
                    ...
                    // references.
                    var ast = ast: {
                        const original_stylesheet = if (asts[source_index.get()]) |value| {
    value
} else {
