    ...
    fn flush(this: *AlignHandler, dest: *css.DeclarationList, context: *css.PropertyHandlerContext) void {
        ...
        if (row_gap != null and column_gap != null) {
            dest.append(context.allocator, Property{ .gap = Gap{
                .row = if (row_gap) |value| {
    value
} else {
    return error.NullPointer;
},
                .column = if (column_gap) |value| {
    value
} else {
    return error.NullPointer;
},
            ...
            if (row_gap != null) {
                bun.handleOom(dest.append(context.allocator, Property{ .@"row-gap" = if (row_gap) |value| {
    value
} else {
    return error.NullPointer;
} }));
            ...
            if (column_gap != null) {
                bun.handleOom(dest.append(context.allocator, Property{ .@"column-gap" = if (column_gap) |value| {
    value
} else {
    return error.NullPointer;
} }));
        ...
        if (align_val.*) |*__v1| {
            ...
            if (justify_val.*) |*__v2| {
                ...
                if (intersection.none) {
                    ...
                    align_prefix[0] = flushPrefixesHelper(this, context, align_prop.feature);
...
// safe-transpile: optional unwrap requires manual review
                        justify_prefix[0] = this.flushPrefixesHelper(context, justify_prop.?.feature);
