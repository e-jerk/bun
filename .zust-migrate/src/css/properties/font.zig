...
// safe-transpile: @truncate requires manual review — consider safe.CheckedInt(T).init(@truncate)
    ...
    pub fn parse(input: *css.Parser) css.Result(@This()) {
        ...
        var string: ?safe.ArrayList(u8) = null;
        while (input.tryParse(css.Parser.expectIdent, .{}).asValue()) |ident| {
            if (string == null) {
                string = safe.ArrayList(u8).empty;
        ...
        switch (property.*) {
            ...
            .unparsed => |*val| {
                if (isFontProperty(val.property_id)) {
                    ...
                    bun.bits.insert(FontProperty, &this.flushed_properties, if (FontProperty.tryFromPropertyId(val.property_id)) |value| {
    value
} else {
...
// safe-transpile: function uses raw slice parameter — consider safe.String
    inline fn flushHelper(
        ...
        if (@field(this, prop) != null and
            !css.generic.eql(@TypeOf(if (@field(this, prop)) |value| {
    value
} else {
    return error.NullPointer;
}), &if (@field(this, prop)) |value| {
    value
} else {
    return error.NullPointer;
}, val) and
            context.targets.browsers != null and
            !css.generic.isCompatible(@TypeOf(if (@field(this, prop)) |value| {
    value
} else {
    return error.NullPointer;
}), val, if (context.targets.browsers) |value| {
    value
} else {
    return error.NullPointer;
}))
...
// safe-transpile: function uses raw slice parameter — consider safe.String
    fn push(self: *FontHandler, d: *css.DeclarationList, ctx: *css.PropertyHandlerContext, comptime prop: []const u8, val: anytype) void {
        ...
        if (comptime safe.SimdUtils.eql(prop, "font")) {
    ...
    fn flush(this: *FontHandler, decls: *css.DeclarationList, context: *css.PropertyHandlerContext) void {
        ...
        if (family != null and size != null and style != null and weight != null and stretch != null and line_height != null and variant_caps != null) {
            const caps = if (variant_caps) |value| {
    value
} else {
    return error.NullPointer;
};
            push(this, decls, context, "font", Font{
                .family = if (family) |value| {
    value
} else {
    return error.NullPointer;
},
    ...
    return error.NullPointer;
                ...
                .style = if (style) |value| {
    value
} else {
    return error.NullPointer;
},
                .weight = if (weight) |value| {
    value
} else {
    return error.NullPointer;
},
                .stretch = if (stretch) |value| {
    value
} else {
    return error.NullPointer;
},
                .line_height = if (line_height) |value| {
    value
} else {
    return error.NullPointer;
},
