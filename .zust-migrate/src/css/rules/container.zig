...
pub const StyleQuery = union(enum) {
    ...
    operation: struct {
        ...
        conditions: safe.ArrayList(StyleQuery),
    ...
    pub fn createOperation(operator: Operator, conditions: safe.ArrayList(StyleQuery)) StyleQuery {
        return .{
            .operation = .{
                .operator = operator,
...
pub const ContainerCondition = union(enum) {
    ...
    operation: struct {
        ...
        operator: css.media_query.Operator,
        /// The conditions for the operator.
        conditions: safe.ArrayList(ContainerCondition),
    ...
    pub fn createOperation(operator: Operator, conditions: safe.ArrayList(ContainerCondition)) ContainerCondition {
        return .{
            .operation = .{
                .operator = operator,
                .conditions = conditions,
