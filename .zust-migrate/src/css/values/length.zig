...
pub const LengthValue = union(enum) {
    ...
    pub fn sign(this: *const @This()) f32 {
        const enum_fields = @typeInfo(if (@typeInfo(@This()).@"union".tag_type) |value| {
    value
} else {
    ...
    pub fn partialCmp(this: *const LengthValue, other: *const LengthValue) ?std.math.Order {
        ...
        if (a != null and b != null) {
            return css.generic.partialCmpF32(&if (a) |value| {
    value
} else {
    return error.NullPointer;
}, &if (b) |value| {
    ...
    pub fn tryOp(
        ...
        const b = this.toPx();
        if (a != null and b != null) {
            return .{ .px = op_fn(ctx, if (a) |value| {
    value
} else {
    return error.NullPointer;
}, if (b) |value| {
