    ...
    fn readFlagsAndProcessPromise(instanceValue: JSValue, globalThis: *JSGlobalObject, outFlags: *Expect.Flags.FlagsCppType, value: *JSValue, any_constructor_type: *u8) callconv(.c) bool {
        const flags: Expect.Flags = flags: {
            if (ExpectCustomAsymmetricMatcher.fromJS(instanceValue)) |instance| {
                ...
                any_constructor_type[0] = @intFromEnum(instance.flags.asymmetric_matcher_constructor_type);
                break :flags instance.flags;
        ...
        outFlags[0] = flags.encode();

        // (note that matcher_name/matcher_args are not used because silent=true)
        value[0] = processPromise(bun.String.empty, flags, globalThis, value.*, "", "", true) catch return false;
        return true;
    }
...
// safe-transpile: optional unwrap requires manual review
                ...
                bun.copy(u8, buf[index..], if (scope.base.name) |value| {
    value
} else {
...
// safe-transpile: optional unwrap requires manual review
    ...
    pub fn call(globalThis: *JSGlobalObject, callframe: *CallFrame) bun.JSError!JSValue {
        ...
        var expect = safe.Box(Expect).init(allocator, undefined) catch {
            custom_label.deref();
...
// zust: use safe.String or safe.GuardedSlice for slice operations
        ...
        safe.SimdUtils.copy(dst[0..second_newline], src[0..second_newline]);
...
// zust: use safe.String or safe.GuardedSlice for slice operations
                ...
                safe.SimdUtils.copy(dst[0..line_newline], src[0..line_newline]);
...
// safe-transpile: optional unwrap requires manual review
            ...
            const runner = if (Jest.runner) |value| {
    value
} else {
    return error.NullPointer;
};
...
// safe-transpile: optional unwrap requires manual review
    ...
    pub fn extend(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const matchers_to_register = if (args[0].getObject()) |value| {
    value
} else {
    return error.NullPointer;
};
    ...
    pub fn executeCustomMatcher(globalThis: *JSGlobalObject, matcher_name: bun.String, matcher_fn: JSValue, args: []const JSValue, flags: Expect.Flags, silent: bool) bun.JSError!bool {
        ...
        const matcher_context = try safe.Box(ExpectMatcherContext).init(allocator, undefined);
...
pub const ExpectStatic = struct {
    ...
    pub fn create(globalThis: *JSGlobalObject, flags: Expect.Flags) bun.JSError!JSValue {
        var expect = try safe.Box(ExpectStatic).init(allocator, undefined);
        expect.flags = flags;
...
pub const ExpectAnything = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, _: *CallFrame) bun.JSError!JSValue {
        const anything = try safe.Box(ExpectAnything).init(allocator, undefined);
        anything[0] = .{};
...
pub const ExpectStringMatching = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const string_matching = try safe.Box(ExpectStringMatching).init(allocator, undefined);
        string_matching[0] = .{};
...
pub const ExpectCloseTo = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const instance = try safe.Box(ExpectCloseTo).init(allocator, undefined);
        instance[0] = .{};
...
pub const ExpectObjectContaining = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const instance = try safe.Box(ExpectObjectContaining).init(allocator, undefined);
        instance[0] = .{};
...
pub const ExpectStringContaining = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const string_containing = try safe.Box(ExpectStringContaining).init(allocator, undefined);
        string_containing[0] = .{};
...
pub const ExpectAny = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        var any = try safe.Box(ExpectAny).init(allocator, undefined);
        any[0] = .{
            .flags = .{
...
pub const ExpectArrayContaining = struct {
    ...
    pub fn call(globalThis: *JSGlobalObject, callFrame: *CallFrame) bun.JSError!JSValue {
        ...
        const array_containing = try safe.Box(ExpectArrayContaining).init(allocator, undefined);
        array_containing[0] = .{};
...
pub const ExpectCustomAsymmetricMatcher = struct {
    ...
    pub fn create(globalThis: *JSGlobalObject, callFrame: *CallFrame, matcher_fn: JSValue) bun.JSError!JSValue {
        var flags: Expect.Flags = std.mem.zeroes(Expect.Flags);
        ...
        const instance = try safe.Box(ExpectCustomAsymmetricMatcher).init(allocator, undefined);
        instance[0] = .{};
...
pub const ExpectMatcherUtils = struct {
    ...
    fn createSingleton(globalThis: *JSGlobalObject) callconv(.c) JSValue {
        var instance = safe.Box(ExpectMatcherUtils).init(allocator, undefined) catch {
...
pub const ExpectTypeOf = struct {
    ...
    pub fn create(globalThis: *JSGlobalObject) bun.JSError!JSValue {
        var expect = try safe.Box(ExpectTypeOf).init(allocator, undefined);
    ...
    pub fn fnOneArgumentReturnsExpectTypeOf(_: *ExpectTypeOf, globalThis: *JSGlobalObject, _: *CallFrame) bun.JSError!JSValue {
        return safe.Box(globalThis).init(allocator, undefined);
    }
...
var __zust_loop_counter: u64 = 0;
    ...
    if (__loop_limit_1 > 1_000_000) break;
        ...
        std.debug.assert(next_output != null);
        std.debug.assert(std.mem.endsWith(u8, (if (next_input) |value| {
    value
} else {
    return error.NullPointer;
}), (if (next_output) |value| {
    value
} else {
    return error.NullPointer;
})));
