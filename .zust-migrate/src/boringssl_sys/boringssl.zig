...
// safe-transpile: optional unwrap requires manual review
    @as(sk_void_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(ptr);
}
pub fn sk_void_call_copy_func(arg_copy_func: OPENSSL_sk_copy_func, arg_ptr: ?*anyopaque) callconv(.c) ?*anyopaque {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    return @as(sk_void_copy_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(copy_func))).?(ptr);
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(sk_void_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_void_new(arg_comp: sk_void_cmp_func) callconv(.c) ?*struct_stack_st_void {
    const comp = arg_comp;
    return @as(?*struct_stack_st_void, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_void_num(arg_sk: ?*const struct_stack_st_void) callconv(.c) usize {
    const sk = arg_sk;
    return sk_num(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_zero(arg_sk: ?*struct_stack_st_void) callconv(.c) void {
    const sk = arg_sk;
    sk_zero(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_value(arg_sk: ?*const struct_stack_st_void, arg_i: usize) callconv(.c) ?*anyopaque {
    ...
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
pub fn sk_void_set(arg_sk: ?*struct_stack_st_void, arg_i: usize, arg_p: ?*anyopaque) callconv(.c) ?*anyopaque {
    const sk = arg_sk;
    const i = arg_i;
    const p = arg_p;
    return sk_set(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), i, p);
}
pub fn sk_void_free(arg_sk: ?*struct_stack_st_void) callconv(.c) void {
    const sk = arg_sk;
    sk_free(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_pop_free(arg_sk: ?*struct_stack_st_void, arg_free_func: sk_void_free_func) callconv(.c) void {
    const sk = arg_sk;
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_void_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
pub fn sk_void_insert(arg_sk: ?*struct_stack_st_void, arg_p: ?*anyopaque, arg_where: usize) callconv(.c) usize {
    const sk = arg_sk;
    const p = arg_p;
    const where = arg_where;
    return sk_insert(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), p, where);
}
pub fn sk_void_delete(arg_sk: ?*struct_stack_st_void, arg_where: usize) callconv(.c) ?*anyopaque {
    const sk = arg_sk;
    const where = arg_where;
    return sk_delete(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), where);
}
pub fn sk_void_delete_ptr(arg_sk: ?*struct_stack_st_void, arg_p: ?*const anyopaque) callconv(.c) ?*anyopaque {
    const sk = arg_sk;
    const p = arg_p;
    return sk_delete_ptr(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), p);
}
pub fn sk_void_find(arg_sk: ?*const struct_stack_st_void, arg_out_index: [*c]usize, arg_p: ?*const anyopaque) callconv(.c) c_int {
    ...
    const p = arg_p;
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, p, &sk_void_call_cmp_func);
}
pub fn sk_void_shift(arg_sk: ?*struct_stack_st_void) callconv(.c) ?*anyopaque {
    const sk = arg_sk;
    return sk_shift(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_push(arg_sk: ?*struct_stack_st_void, arg_p: ?*anyopaque) callconv(.c) usize {
    const sk = arg_sk;
    const p = arg_p;
    return sk_push(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), p);
}
pub fn sk_void_pop(arg_sk: ?*struct_stack_st_void) callconv(.c) ?*anyopaque {
    const sk = arg_sk;
    return sk_pop(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_dup(arg_sk: ?*const struct_stack_st_void) callconv(.c) ?*struct_stack_st_void {
    const sk = arg_sk;
    return @as(?*struct_stack_st_void, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_dup(@as([*c]const _STACK, @ptrCast(@alignCast(sk))))));
}
pub fn sk_void_sort(arg_sk: ?*struct_stack_st_void) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_void_call_cmp_func);
}
pub fn sk_void_is_sorted(arg_sk: ?*const struct_stack_st_void) callconv(.c) c_int {
    const sk = arg_sk;
    return sk_is_sorted(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))));
}
pub fn sk_void_set_cmp_func(arg_sk: ?*struct_stack_st_void, arg_comp: sk_void_cmp_func) callconv(.c) sk_void_cmp_func {
    ...
    const comp = arg_comp;
    return @as(sk_void_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_set_cmp_func(@as([*c]_STACK, @ptrCast(@alignCast(sk))), @as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp)))))));
}
pub fn sk_void_deep_copy(arg_sk: ?*const struct_stack_st_void, arg_copy_func: sk_void_copy_func, arg_free_func: sk_void_free_func) callconv(.c) ?*struct_stack_st_void {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_void, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_void_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_void_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_OPENSSL_STRING_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_OPENSSL_STRING_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
...
pub fn sk_OPENSSL_STRING_call_copy_func(arg_copy_func: OPENSSL_sk_copy_func, arg_ptr: ?*anyopaque) callconv(.c) ?*anyopaque {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_OPENSSL_STRING_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]u8, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_OPENSSL_STRING_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const u8 = @as([*c]const u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const u8 = @as([*c]const u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_OPENSSL_STRING_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_OPENSSL_STRING_new(arg_comp: sk_OPENSSL_STRING_cmp_func) callconv(.c) ?*struct_stack_st_OPENSSL_STRING {
    const comp = arg_comp;
    return @as(?*struct_stack_st_OPENSSL_STRING, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_OPENSSL_STRING_value(arg_sk: ?*const struct_stack_st_OPENSSL_STRING, arg_i: usize) callconv(.c) [*c]u8 {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
pub fn sk_OPENSSL_STRING_set(arg_sk: ?*struct_stack_st_OPENSSL_STRING, arg_i: usize, arg_p: [*c]u8) callconv(.c) [*c]u8 {
    ...
    const p = arg_p;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_set(@as([*c]_STACK, @ptrCast(@alignCast(sk))), i, @as(?*anyopaque, @ptrCast(p))))));
}
...
pub fn sk_OPENSSL_STRING_pop_free(arg_sk: ?*struct_stack_st_OPENSSL_STRING, arg_free_func: sk_OPENSSL_STRING_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_OPENSSL_STRING_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
pub fn sk_OPENSSL_STRING_insert(arg_sk: ?*struct_stack_st_OPENSSL_STRING, arg_p: [*c]u8, arg_where: usize) callconv(.c) usize {
    ...
    const where = arg_where;
    return sk_insert(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), where);
}
pub fn sk_OPENSSL_STRING_delete(arg_sk: ?*struct_stack_st_OPENSSL_STRING, arg_where: usize) callconv(.c) [*c]u8 {
    ...
    const where = arg_where;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_delete(@as([*c]_STACK, @ptrCast(@alignCast(sk))), where))));
}
pub fn sk_OPENSSL_STRING_delete_ptr(arg_sk: ?*struct_stack_st_OPENSSL_STRING, arg_p: [*c]const u8) callconv(.c) [*c]u8 {
    const sk = arg_sk;
    const p = arg_p;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_delete_ptr(@as([*c]_STACK, @ptrCast(@alignCast(sk))), @as(?*const anyopaque, @ptrCast(p))))));
}
pub fn sk_OPENSSL_STRING_find(arg_sk: ?*const struct_stack_st_OPENSSL_STRING, arg_out_index: [*c]usize, arg_p: [*c]const u8) callconv(.c) c_int {
    ...
    const p = arg_p;
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_OPENSSL_STRING_call_cmp_func);
}
pub fn sk_OPENSSL_STRING_shift(arg_sk: ?*struct_stack_st_OPENSSL_STRING) callconv(.c) [*c]u8 {
    const sk = arg_sk;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_shift(@as([*c]_STACK, @ptrCast(@alignCast(sk)))))));
}
...
pub fn sk_OPENSSL_STRING_pop(arg_sk: ?*struct_stack_st_OPENSSL_STRING) callconv(.c) [*c]u8 {
    const sk = arg_sk;
    return @as([*c]u8, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_pop(@as([*c]_STACK, @ptrCast(@alignCast(sk)))))));
}
...
pub fn sk_OPENSSL_STRING_sort(arg_sk: ?*struct_stack_st_OPENSSL_STRING) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_OPENSSL_STRING_call_cmp_func);
}
...
pub fn sk_OPENSSL_STRING_deep_copy(arg_sk: ?*const struct_stack_st_OPENSSL_STRING, arg_copy_func: sk_OPENSSL_STRING_copy_func, arg_free_func: sk_OPENSSL_STRING_free_func) callconv(.c) ?*struct_stack_st_OPENSSL_STRING {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_OPENSSL_STRING, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_OPENSSL_STRING_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_OPENSSL_STRING_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_BIO_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_BIO_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_BIO_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]BIO, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_BIO_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const BIO = @as([*c]const BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const BIO = @as([*c]const BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_BIO_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_BIO_new(arg_comp: sk_BIO_cmp_func) callconv(.c) ?*struct_stack_st_BIO {
    const comp = arg_comp;
    return @as(?*struct_stack_st_BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_BIO_value(arg_sk: ?*const struct_stack_st_BIO, arg_i: usize) callconv(.c) [*c]BIO {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_BIO_pop_free(arg_sk: ?*struct_stack_st_BIO, arg_free_func: sk_BIO_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_BIO_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_BIO_find(arg_sk: ?*const struct_stack_st_BIO, arg_out_index: [*c]usize, arg_p: [*c]const BIO) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_BIO_call_cmp_func);
}
...
pub fn sk_BIO_sort(arg_sk: ?*struct_stack_st_BIO) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_BIO_call_cmp_func);
}
...
pub fn sk_BIO_deep_copy(arg_sk: ?*const struct_stack_st_BIO, arg_copy_func: sk_BIO_copy_func, arg_free_func: sk_BIO_free_func) callconv(.c) ?*struct_stack_st_BIO {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_BIO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_BIO_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_BIO_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const ASN1_BOOLEAN_it: ASN1_ITEM = undefined;
pub extern const ASN1_TBOOLEAN_it: ASN1_ITEM = undefined;
pub extern const ASN1_FBOOLEAN_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_BMPSTRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_GENERALSTRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_IA5STRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_OCTET_STRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_PRINTABLESTRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_T61STRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_UNIVERSALSTRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_UTF8STRING_it: ASN1_ITEM = undefined;
pub extern const ASN1_VISIBLESTRING_it: ASN1_ITEM = undefined;
...
pub extern const DIRECTORYSTRING_it: ASN1_ITEM = undefined;
...
pub extern const DISPLAYTEXT_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_BIT_STRING_it: ASN1_ITEM = undefined;
...
pub fn sk_ASN1_INTEGER_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_ASN1_INTEGER_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_ASN1_INTEGER_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]ASN1_INTEGER, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_ASN1_INTEGER_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const ASN1_INTEGER = @as([*c]const ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const ASN1_INTEGER = @as([*c]const ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_ASN1_INTEGER_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_ASN1_INTEGER_new(arg_comp: sk_ASN1_INTEGER_cmp_func) callconv(.c) ?*struct_stack_st_ASN1_INTEGER {
    const comp = arg_comp;
    return @as(?*struct_stack_st_ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_ASN1_INTEGER_value(arg_sk: ?*const struct_stack_st_ASN1_INTEGER, arg_i: usize) callconv(.c) [*c]ASN1_INTEGER {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_ASN1_INTEGER_pop_free(arg_sk: ?*struct_stack_st_ASN1_INTEGER, arg_free_func: sk_ASN1_INTEGER_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_INTEGER_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_ASN1_INTEGER_find(arg_sk: ?*const struct_stack_st_ASN1_INTEGER, arg_out_index: [*c]usize, arg_p: [*c]const ASN1_INTEGER) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_ASN1_INTEGER_call_cmp_func);
}
...
pub fn sk_ASN1_INTEGER_sort(arg_sk: ?*struct_stack_st_ASN1_INTEGER) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_INTEGER_call_cmp_func);
}
...
pub fn sk_ASN1_INTEGER_deep_copy(arg_sk: ?*const struct_stack_st_ASN1_INTEGER, arg_copy_func: sk_ASN1_INTEGER_copy_func, arg_free_func: sk_ASN1_INTEGER_free_func) callconv(.c) ?*struct_stack_st_ASN1_INTEGER {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_ASN1_INTEGER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_ASN1_INTEGER_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_ASN1_INTEGER_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const ASN1_INTEGER_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_ENUMERATED_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_UTCTIME_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_GENERALIZEDTIME_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_TIME_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_NULL_it: ASN1_ITEM = undefined;
...
pub fn sk_ASN1_OBJECT_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_ASN1_OBJECT_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_ASN1_OBJECT_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*ASN1_OBJECT, @ptrCast(ptr)))));
}
pub fn sk_ASN1_OBJECT_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const ASN1_OBJECT = @as(?*const ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const ASN1_OBJECT = @as(?*const ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_ASN1_OBJECT_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_ASN1_OBJECT_new(arg_comp: sk_ASN1_OBJECT_cmp_func) callconv(.c) ?*struct_stack_st_ASN1_OBJECT {
    const comp = arg_comp;
    return @as(?*struct_stack_st_ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_ASN1_OBJECT_value(arg_sk: ?*const struct_stack_st_ASN1_OBJECT, arg_i: usize) callconv(.c) ?*ASN1_OBJECT {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
pub fn sk_ASN1_OBJECT_set(arg_sk: ?*struct_stack_st_ASN1_OBJECT, arg_i: usize, arg_p: ?*ASN1_OBJECT) callconv(.c) ?*ASN1_OBJECT {
    ...
    const p = arg_p;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_set(@as([*c]_STACK, @ptrCast(@alignCast(sk))), i, @as(?*anyopaque, @ptrCast(p)))));
}
...
pub fn sk_ASN1_OBJECT_pop_free(arg_sk: ?*struct_stack_st_ASN1_OBJECT, arg_free_func: sk_ASN1_OBJECT_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_OBJECT_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_ASN1_OBJECT_delete(arg_sk: ?*struct_stack_st_ASN1_OBJECT, arg_where: usize) callconv(.c) ?*ASN1_OBJECT {
    ...
    const where = arg_where;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_delete(@as([*c]_STACK, @ptrCast(@alignCast(sk))), where)));
}
pub fn sk_ASN1_OBJECT_delete_ptr(arg_sk: ?*struct_stack_st_ASN1_OBJECT, arg_p: ?*const ASN1_OBJECT) callconv(.c) ?*ASN1_OBJECT {
    const sk = arg_sk;
    const p = arg_p;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_delete_ptr(@as([*c]_STACK, @ptrCast(@alignCast(sk))), @as(?*const anyopaque, @ptrCast(p)))));
}
pub fn sk_ASN1_OBJECT_find(arg_sk: ?*const struct_stack_st_ASN1_OBJECT, arg_out_index: [*c]usize, arg_p: ?*const ASN1_OBJECT) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_ASN1_OBJECT_call_cmp_func);
}
pub fn sk_ASN1_OBJECT_shift(arg_sk: ?*struct_stack_st_ASN1_OBJECT) callconv(.c) ?*ASN1_OBJECT {
    const sk = arg_sk;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_shift(@as([*c]_STACK, @ptrCast(@alignCast(sk))))));
}
...
pub fn sk_ASN1_OBJECT_pop(arg_sk: ?*struct_stack_st_ASN1_OBJECT) callconv(.c) ?*ASN1_OBJECT {
    const sk = arg_sk;
    return @as(?*ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_pop(@as([*c]_STACK, @ptrCast(@alignCast(sk))))));
}
...
pub fn sk_ASN1_OBJECT_sort(arg_sk: ?*struct_stack_st_ASN1_OBJECT) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_OBJECT_call_cmp_func);
}
...
pub fn sk_ASN1_OBJECT_deep_copy(arg_sk: ?*const struct_stack_st_ASN1_OBJECT, arg_copy_func: sk_ASN1_OBJECT_copy_func, arg_free_func: sk_ASN1_OBJECT_free_func) callconv(.c) ?*struct_stack_st_ASN1_OBJECT {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_ASN1_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_ASN1_OBJECT_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_ASN1_OBJECT_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const ASN1_OBJECT_it: ASN1_ITEM = undefined;
...
pub fn sk_ASN1_TYPE_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_ASN1_TYPE_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_ASN1_TYPE_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]ASN1_TYPE, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_ASN1_TYPE_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const ASN1_TYPE = @as([*c]const ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const ASN1_TYPE = @as([*c]const ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_ASN1_TYPE_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_ASN1_TYPE_new(arg_comp: sk_ASN1_TYPE_cmp_func) callconv(.c) ?*struct_stack_st_ASN1_TYPE {
    const comp = arg_comp;
    return @as(?*struct_stack_st_ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_ASN1_TYPE_value(arg_sk: ?*const struct_stack_st_ASN1_TYPE, arg_i: usize) callconv(.c) [*c]ASN1_TYPE {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_ASN1_TYPE_pop_free(arg_sk: ?*struct_stack_st_ASN1_TYPE, arg_free_func: sk_ASN1_TYPE_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_TYPE_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_ASN1_TYPE_find(arg_sk: ?*const struct_stack_st_ASN1_TYPE, arg_out_index: [*c]usize, arg_p: [*c]const ASN1_TYPE) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_ASN1_TYPE_call_cmp_func);
}
...
pub fn sk_ASN1_TYPE_sort(arg_sk: ?*struct_stack_st_ASN1_TYPE) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_ASN1_TYPE_call_cmp_func);
}
...
pub fn sk_ASN1_TYPE_deep_copy(arg_sk: ?*const struct_stack_st_ASN1_TYPE, arg_copy_func: sk_ASN1_TYPE_copy_func, arg_free_func: sk_ASN1_TYPE_free_func) callconv(.c) ?*struct_stack_st_ASN1_TYPE {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_ASN1_TYPE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_ASN1_TYPE_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_ASN1_TYPE_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const ASN1_ANY_it: ASN1_ITEM = undefined;
...
pub extern const ASN1_PRINTABLE_it: ASN1_ITEM = undefined;
...
pub fn sk_CRYPTO_BUFFER_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_CRYPTO_BUFFER_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_CRYPTO_BUFFER_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*CRYPTO_BUFFER, @ptrCast(ptr)))));
}
pub fn sk_CRYPTO_BUFFER_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const CRYPTO_BUFFER = @as(?*const CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const CRYPTO_BUFFER = @as(?*const CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_CRYPTO_BUFFER_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_CRYPTO_BUFFER_new(arg_comp: sk_CRYPTO_BUFFER_cmp_func) callconv(.c) ?*struct_stack_st_CRYPTO_BUFFER {
    const comp = arg_comp;
    return @as(?*struct_stack_st_CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_CRYPTO_BUFFER_value(arg_sk: ?*const struct_stack_st_CRYPTO_BUFFER, arg_i: usize) callconv(.c) ?*CRYPTO_BUFFER {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_CRYPTO_BUFFER_pop_free(arg_sk: ?*struct_stack_st_CRYPTO_BUFFER, arg_free_func: sk_CRYPTO_BUFFER_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_CRYPTO_BUFFER_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_CRYPTO_BUFFER_find(arg_sk: ?*const struct_stack_st_CRYPTO_BUFFER, arg_out_index: [*c]usize, arg_p: ?*const CRYPTO_BUFFER) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_CRYPTO_BUFFER_call_cmp_func);
}
...
pub fn sk_CRYPTO_BUFFER_sort(arg_sk: ?*struct_stack_st_CRYPTO_BUFFER) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_CRYPTO_BUFFER_call_cmp_func);
}
...
pub fn sk_CRYPTO_BUFFER_deep_copy(arg_sk: ?*const struct_stack_st_CRYPTO_BUFFER, arg_copy_func: sk_CRYPTO_BUFFER_copy_func, arg_free_func: sk_CRYPTO_BUFFER_free_func) callconv(.c) ?*struct_stack_st_CRYPTO_BUFFER {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_CRYPTO_BUFFER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_CRYPTO_BUFFER_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_CRYPTO_BUFFER_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509, @ptrCast(ptr)))));
}
pub fn sk_X509_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509 = @as(?*const X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509 = @as(?*const X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_new(arg_comp: sk_X509_cmp_func) callconv(.c) ?*struct_stack_st_X509 {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_value(arg_sk: ?*const struct_stack_st_X509, arg_i: usize) callconv(.c) ?*X509 {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_pop_free(arg_sk: ?*struct_stack_st_X509, arg_free_func: sk_X509_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_find(arg_sk: ?*const struct_stack_st_X509, arg_out_index: [*c]usize, arg_p: ?*const X509) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_call_cmp_func);
}
...
pub fn sk_X509_sort(arg_sk: ?*struct_stack_st_X509) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_call_cmp_func);
}
...
pub fn sk_X509_deep_copy(arg_sk: ?*const struct_stack_st_X509, arg_copy_func: sk_X509_copy_func, arg_free_func: sk_X509_free_func) callconv(.c) ?*struct_stack_st_X509 {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const X509_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_CRL_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_CRL_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
pub fn sk_X509_CRL_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_CRL = @as(?*const X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_CRL = @as(?*const X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_CRL_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
...
pub fn sk_GENERAL_NAME_call_free_func(arg_free_func: stack_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(stack_GENERAL_NAME_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*struct_stack_st_GENERAL_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
pub fn sk_GENERAL_NAME_pop_free(arg_sk: ?*struct_stack_st_GENERAL_NAME, arg_free_func: stack_GENERAL_NAME_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), sk_GENERAL_NAME_call_free_func, @as(stack_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(free_func)));
}
...
pub fn sk_ACCESS_DESCRIPTION_call_free_func(arg_free_func: stack_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(stack_ACCESS_DESCRIPTION_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(free_func)).?(@as(?*AUTHORITY_INFO_ACCESS, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
pub fn sk_ACCESS_DESCRIPTION_pop_free(arg_sk: ?*AUTHORITY_INFO_ACCESS, arg_free_func: stack_ACCESS_DESCRIPTION_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), sk_ACCESS_DESCRIPTION_call_free_func, @as(stack_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(free_func)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(stack_X509_CRL_copy_func, @ptrCast(copy_func)).?(@as(?*X509_CRL, @ptrCast(ptr)))));
}
pub fn sk_X509_CRL_new(arg_comp: stack_X509_CRL_cmp_func) callconv(.c) ?*struct_stack_st_X509_CRL {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(stack_cmp_func, @ptrCast(comp)))));
}
...
pub fn sk_X509_CRL_value(arg_sk: ?*const struct_stack_st_X509_CRL, arg_i: usize) callconv(.c) ?*X509_CRL {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_CRL_pop_free(arg_sk: ?*struct_stack_st_X509_CRL, arg_free_func: sk_X509_CRL_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_CRL_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_CRL_find(arg_sk: ?*const struct_stack_st_X509_CRL, arg_out_index: [*c]usize, arg_p: ?*const X509_CRL) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_CRL_call_cmp_func);
}
...
pub fn sk_X509_CRL_sort(arg_sk: ?*struct_stack_st_X509_CRL) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_CRL_call_cmp_func);
}
...
pub fn sk_X509_CRL_deep_copy(arg_sk: ?*const struct_stack_st_X509_CRL, arg_copy_func: sk_X509_CRL_copy_func, arg_free_func: sk_X509_CRL_free_func) callconv(.c) ?*struct_stack_st_X509_CRL {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_CRL, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_CRL_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_CRL_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
pub extern const X509_CRL_it: ASN1_ITEM = undefined;
...
pub extern const X509_REQ_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_NAME_ENTRY_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_NAME_ENTRY_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_NAME_ENTRY_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_NAME_ENTRY, @ptrCast(ptr)))));
}
pub fn sk_X509_NAME_ENTRY_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_NAME_ENTRY = @as(?*const X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_NAME_ENTRY = @as(?*const X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_NAME_ENTRY_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_NAME_ENTRY_new(arg_comp: sk_X509_NAME_ENTRY_cmp_func) callconv(.c) ?*struct_stack_st_X509_NAME_ENTRY {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_NAME_ENTRY_value(arg_sk: ?*const struct_stack_st_X509_NAME_ENTRY, arg_i: usize) callconv(.c) ?*X509_NAME_ENTRY {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_NAME_ENTRY_pop_free(arg_sk: ?*struct_stack_st_X509_NAME_ENTRY, arg_free_func: sk_X509_NAME_ENTRY_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_NAME_ENTRY_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_NAME_ENTRY_find(arg_sk: ?*const struct_stack_st_X509_NAME_ENTRY, arg_out_index: [*c]usize, arg_p: ?*const X509_NAME_ENTRY) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_NAME_ENTRY_call_cmp_func);
}
...
pub fn sk_X509_NAME_ENTRY_sort(arg_sk: ?*struct_stack_st_X509_NAME_ENTRY) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_NAME_ENTRY_call_cmp_func);
}
...
pub fn sk_X509_NAME_ENTRY_deep_copy(arg_sk: ?*const struct_stack_st_X509_NAME_ENTRY, arg_copy_func: sk_X509_NAME_ENTRY_copy_func, arg_free_func: sk_X509_NAME_ENTRY_free_func) callconv(.c) ?*struct_stack_st_X509_NAME_ENTRY {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_NAME_ENTRY, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_NAME_ENTRY_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_NAME_ENTRY_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_NAME_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_NAME_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_NAME_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_NAME, @ptrCast(ptr)))));
}
pub fn sk_X509_NAME_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_NAME = @as(?*const X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_NAME = @as(?*const X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_NAME_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_NAME_new(arg_comp: sk_X509_NAME_cmp_func) callconv(.c) ?*struct_stack_st_X509_NAME {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_NAME_value(arg_sk: ?*const struct_stack_st_X509_NAME, arg_i: usize) callconv(.c) ?*X509_NAME {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_NAME_pop_free(arg_sk: ?*struct_stack_st_X509_NAME, arg_free_func: sk_X509_NAME_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_NAME_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_NAME_find(arg_sk: ?*const struct_stack_st_X509_NAME, arg_out_index: [*c]usize, arg_p: ?*const X509_NAME) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_NAME_call_cmp_func);
}
...
pub fn sk_X509_NAME_sort(arg_sk: ?*struct_stack_st_X509_NAME) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_NAME_call_cmp_func);
}
...
pub fn sk_X509_NAME_deep_copy(arg_sk: ?*const struct_stack_st_X509_NAME, arg_copy_func: sk_X509_NAME_copy_func, arg_free_func: sk_X509_NAME_free_func) callconv(.c) ?*struct_stack_st_X509_NAME {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_NAME, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_NAME_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_NAME_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
pub extern const X509_NAME_it: ASN1_ITEM = undefined;
...
pub extern const X509_NAME_ENTRY_it: ASN1_ITEM = undefined;
...
pub extern const X509_EXTENSION_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_EXTENSION_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_EXTENSION_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_EXTENSION_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_EXTENSION, @ptrCast(ptr)))));
}
pub fn sk_X509_EXTENSION_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_EXTENSION = @as(?*const X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_EXTENSION = @as(?*const X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_EXTENSION_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_EXTENSION_new(arg_comp: sk_X509_EXTENSION_cmp_func) callconv(.c) ?*struct_stack_st_X509_EXTENSION {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_EXTENSION_value(arg_sk: ?*const struct_stack_st_X509_EXTENSION, arg_i: usize) callconv(.c) ?*X509_EXTENSION {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_EXTENSION_pop_free(arg_sk: ?*struct_stack_st_X509_EXTENSION, arg_free_func: sk_X509_EXTENSION_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_EXTENSION_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_EXTENSION_find(arg_sk: ?*const struct_stack_st_X509_EXTENSION, arg_out_index: [*c]usize, arg_p: ?*const X509_EXTENSION) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_EXTENSION_call_cmp_func);
}
...
pub fn sk_X509_EXTENSION_sort(arg_sk: ?*struct_stack_st_X509_EXTENSION) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_EXTENSION_call_cmp_func);
}
...
pub fn sk_X509_EXTENSION_deep_copy(arg_sk: ?*const struct_stack_st_X509_EXTENSION, arg_copy_func: sk_X509_EXTENSION_copy_func, arg_free_func: sk_X509_EXTENSION_free_func) callconv(.c) ?*struct_stack_st_X509_EXTENSION {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_EXTENSION, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_EXTENSION_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_EXTENSION_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
pub const X509_EXTENSIONS = struct_stack_st_X509_EXTENSION;
pub extern const X509_EXTENSIONS_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_ALGOR_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_ALGOR_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_ALGOR_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]X509_ALGOR, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_X509_ALGOR_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const X509_ALGOR = @as([*c]const X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const X509_ALGOR = @as([*c]const X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_ALGOR_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_ALGOR_new(arg_comp: sk_X509_ALGOR_cmp_func) callconv(.c) ?*struct_stack_st_X509_ALGOR {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_ALGOR_value(arg_sk: ?*const struct_stack_st_X509_ALGOR, arg_i: usize) callconv(.c) [*c]X509_ALGOR {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_X509_ALGOR_pop_free(arg_sk: ?*struct_stack_st_X509_ALGOR, arg_free_func: sk_X509_ALGOR_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_ALGOR_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_ALGOR_find(arg_sk: ?*const struct_stack_st_X509_ALGOR, arg_out_index: [*c]usize, arg_p: [*c]const X509_ALGOR) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_ALGOR_call_cmp_func);
}
...
pub fn sk_X509_ALGOR_sort(arg_sk: ?*struct_stack_st_X509_ALGOR) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_ALGOR_call_cmp_func);
}
...
pub fn sk_X509_ALGOR_deep_copy(arg_sk: ?*const struct_stack_st_X509_ALGOR, arg_copy_func: sk_X509_ALGOR_copy_func, arg_free_func: sk_X509_ALGOR_free_func) callconv(.c) ?*struct_stack_st_X509_ALGOR {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_ALGOR, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_ALGOR_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_ALGOR_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
pub extern const X509_ALGOR_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_ATTRIBUTE_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_ATTRIBUTE_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_ATTRIBUTE_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_ATTRIBUTE, @ptrCast(ptr)))));
}
pub fn sk_X509_ATTRIBUTE_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_ATTRIBUTE = @as(?*const X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_ATTRIBUTE = @as(?*const X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_ATTRIBUTE_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_ATTRIBUTE_new(arg_comp: sk_X509_ATTRIBUTE_cmp_func) callconv(.c) ?*struct_stack_st_X509_ATTRIBUTE {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_ATTRIBUTE_value(arg_sk: ?*const struct_stack_st_X509_ATTRIBUTE, arg_i: usize) callconv(.c) ?*X509_ATTRIBUTE {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_ATTRIBUTE_pop_free(arg_sk: ?*struct_stack_st_X509_ATTRIBUTE, arg_free_func: sk_X509_ATTRIBUTE_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_ATTRIBUTE_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_ATTRIBUTE_find(arg_sk: ?*const struct_stack_st_X509_ATTRIBUTE, arg_out_index: [*c]usize, arg_p: ?*const X509_ATTRIBUTE) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_ATTRIBUTE_call_cmp_func);
}
...
pub fn sk_X509_ATTRIBUTE_sort(arg_sk: ?*struct_stack_st_X509_ATTRIBUTE) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_ATTRIBUTE_call_cmp_func);
}
...
pub fn sk_X509_ATTRIBUTE_deep_copy(arg_sk: ?*const struct_stack_st_X509_ATTRIBUTE, arg_copy_func: sk_X509_ATTRIBUTE_copy_func, arg_free_func: sk_X509_ATTRIBUTE_free_func) callconv(.c) ?*struct_stack_st_X509_ATTRIBUTE {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_ATTRIBUTE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_ATTRIBUTE_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_ATTRIBUTE_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_TRUST_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_TRUST_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_TRUST_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]X509_TRUST, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_X509_TRUST_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const X509_TRUST = @as([*c]const X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const X509_TRUST = @as([*c]const X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_TRUST_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_TRUST_new(arg_comp: sk_X509_TRUST_cmp_func) callconv(.c) ?*struct_stack_st_X509_TRUST {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_TRUST_value(arg_sk: ?*const struct_stack_st_X509_TRUST, arg_i: usize) callconv(.c) [*c]X509_TRUST {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_X509_TRUST_pop_free(arg_sk: ?*struct_stack_st_X509_TRUST, arg_free_func: sk_X509_TRUST_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_TRUST_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_TRUST_find(arg_sk: ?*const struct_stack_st_X509_TRUST, arg_out_index: [*c]usize, arg_p: [*c]const X509_TRUST) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_TRUST_call_cmp_func);
}
...
pub fn sk_X509_TRUST_sort(arg_sk: ?*struct_stack_st_X509_TRUST) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_TRUST_call_cmp_func);
}
...
pub fn sk_X509_TRUST_deep_copy(arg_sk: ?*const struct_stack_st_X509_TRUST, arg_copy_func: sk_X509_TRUST_copy_func, arg_free_func: sk_X509_TRUST_free_func) callconv(.c) ?*struct_stack_st_X509_TRUST {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_TRUST, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_TRUST_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_TRUST_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_REVOKED_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_REVOKED_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_REVOKED_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_REVOKED, @ptrCast(ptr)))));
}
pub fn sk_X509_REVOKED_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_REVOKED = @as(?*const X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_REVOKED = @as(?*const X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_REVOKED_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_REVOKED_new(arg_comp: sk_X509_REVOKED_cmp_func) callconv(.c) ?*struct_stack_st_X509_REVOKED {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_REVOKED_value(arg_sk: ?*const struct_stack_st_X509_REVOKED, arg_i: usize) callconv(.c) ?*X509_REVOKED {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_REVOKED_pop_free(arg_sk: ?*struct_stack_st_X509_REVOKED, arg_free_func: sk_X509_REVOKED_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_REVOKED_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_REVOKED_find(arg_sk: ?*const struct_stack_st_X509_REVOKED, arg_out_index: [*c]usize, arg_p: ?*const X509_REVOKED) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_REVOKED_call_cmp_func);
}
...
pub fn sk_X509_REVOKED_sort(arg_sk: ?*struct_stack_st_X509_REVOKED) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_REVOKED_call_cmp_func);
}
...
pub fn sk_X509_REVOKED_deep_copy(arg_sk: ?*const struct_stack_st_X509_REVOKED, arg_copy_func: sk_X509_REVOKED_copy_func, arg_free_func: sk_X509_REVOKED_free_func) callconv(.c) ?*struct_stack_st_X509_REVOKED {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_REVOKED, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_REVOKED_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_REVOKED_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_INFO_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_INFO_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_INFO_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]X509_INFO, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_X509_INFO_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const X509_INFO = @as([*c]const X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const X509_INFO = @as([*c]const X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_INFO_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_INFO_new(arg_comp: sk_X509_INFO_cmp_func) callconv(.c) ?*struct_stack_st_X509_INFO {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_INFO_value(arg_sk: ?*const struct_stack_st_X509_INFO, arg_i: usize) callconv(.c) [*c]X509_INFO {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_X509_INFO_pop_free(arg_sk: ?*struct_stack_st_X509_INFO, arg_free_func: sk_X509_INFO_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_INFO_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_INFO_find(arg_sk: ?*const struct_stack_st_X509_INFO, arg_out_index: [*c]usize, arg_p: [*c]const X509_INFO) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_INFO_call_cmp_func);
}
...
pub fn sk_X509_INFO_sort(arg_sk: ?*struct_stack_st_X509_INFO) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_INFO_call_cmp_func);
}
...
pub fn sk_X509_INFO_deep_copy(arg_sk: ?*const struct_stack_st_X509_INFO, arg_copy_func: sk_X509_INFO_copy_func, arg_free_func: sk_X509_INFO_free_func) callconv(.c) ?*struct_stack_st_X509_INFO {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_INFO, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_INFO_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_INFO_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub extern const X509_PUBKEY_it: ASN1_ITEM = undefined;
...
pub extern const X509_SIG_it: ASN1_ITEM = undefined;
...
pub extern const X509_ATTRIBUTE_it: ASN1_ITEM = undefined;
...
pub extern const X509_REVOKED_it: ASN1_ITEM = undefined;
...
pub extern const NETSCAPE_SPKI_it: ASN1_ITEM = undefined;
...
pub extern const NETSCAPE_SPKAC_it: ASN1_ITEM = undefined;
...
pub extern const PKCS8_PRIV_KEY_INFO_it: ASN1_ITEM = undefined;
...
pub extern const RSA_PSS_PARAMS_it: ASN1_ITEM = undefined;
...
pub fn sk_X509_LOOKUP_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_LOOKUP_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_LOOKUP_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_LOOKUP, @ptrCast(ptr)))));
}
pub fn sk_X509_LOOKUP_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_LOOKUP = @as(?*const X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_LOOKUP = @as(?*const X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_LOOKUP_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_LOOKUP_new(arg_comp: sk_X509_LOOKUP_cmp_func) callconv(.c) ?*struct_stack_st_X509_LOOKUP {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_LOOKUP_value(arg_sk: ?*const struct_stack_st_X509_LOOKUP, arg_i: usize) callconv(.c) ?*X509_LOOKUP {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_LOOKUP_pop_free(arg_sk: ?*struct_stack_st_X509_LOOKUP, arg_free_func: sk_X509_LOOKUP_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_LOOKUP_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_LOOKUP_find(arg_sk: ?*const struct_stack_st_X509_LOOKUP, arg_out_index: [*c]usize, arg_p: ?*const X509_LOOKUP) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_LOOKUP_call_cmp_func);
}
...
pub fn sk_X509_LOOKUP_sort(arg_sk: ?*struct_stack_st_X509_LOOKUP) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_LOOKUP_call_cmp_func);
}
...
pub fn sk_X509_LOOKUP_deep_copy(arg_sk: ?*const struct_stack_st_X509_LOOKUP, arg_copy_func: sk_X509_LOOKUP_copy_func, arg_free_func: sk_X509_LOOKUP_free_func) callconv(.c) ?*struct_stack_st_X509_LOOKUP {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_LOOKUP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_LOOKUP_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_LOOKUP_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_OBJECT_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_OBJECT_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_OBJECT_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_OBJECT, @ptrCast(ptr)))));
}
pub fn sk_X509_OBJECT_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_OBJECT = @as(?*const X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_OBJECT = @as(?*const X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_OBJECT_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_OBJECT_new(arg_comp: sk_X509_OBJECT_cmp_func) callconv(.c) ?*struct_stack_st_X509_OBJECT {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_OBJECT_value(arg_sk: ?*const struct_stack_st_X509_OBJECT, arg_i: usize) callconv(.c) ?*X509_OBJECT {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_OBJECT_pop_free(arg_sk: ?*struct_stack_st_X509_OBJECT, arg_free_func: sk_X509_OBJECT_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_OBJECT_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_OBJECT_find(arg_sk: ?*const struct_stack_st_X509_OBJECT, arg_out_index: [*c]usize, arg_p: ?*const X509_OBJECT) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_OBJECT_call_cmp_func);
}
...
pub fn sk_X509_OBJECT_sort(arg_sk: ?*struct_stack_st_X509_OBJECT) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_OBJECT_call_cmp_func);
}
...
pub fn sk_X509_OBJECT_deep_copy(arg_sk: ?*const struct_stack_st_X509_OBJECT, arg_copy_func: sk_X509_OBJECT_copy_func, arg_free_func: sk_X509_OBJECT_free_func) callconv(.c) ?*struct_stack_st_X509_OBJECT {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_OBJECT, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_OBJECT_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_OBJECT_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_X509_VERIFY_PARAM_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_X509_VERIFY_PARAM_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_X509_VERIFY_PARAM_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*X509_VERIFY_PARAM, @ptrCast(ptr)))));
}
pub fn sk_X509_VERIFY_PARAM_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const X509_VERIFY_PARAM = @as(?*const X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const X509_VERIFY_PARAM = @as(?*const X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_X509_VERIFY_PARAM_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_X509_VERIFY_PARAM_new(arg_comp: sk_X509_VERIFY_PARAM_cmp_func) callconv(.c) ?*struct_stack_st_X509_VERIFY_PARAM {
    const comp = arg_comp;
    return @as(?*struct_stack_st_X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_X509_VERIFY_PARAM_value(arg_sk: ?*const struct_stack_st_X509_VERIFY_PARAM, arg_i: usize) callconv(.c) ?*X509_VERIFY_PARAM {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
...
pub fn sk_X509_VERIFY_PARAM_pop_free(arg_sk: ?*struct_stack_st_X509_VERIFY_PARAM, arg_free_func: sk_X509_VERIFY_PARAM_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_VERIFY_PARAM_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_X509_VERIFY_PARAM_find(arg_sk: ?*const struct_stack_st_X509_VERIFY_PARAM, arg_out_index: [*c]usize, arg_p: ?*const X509_VERIFY_PARAM) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_X509_VERIFY_PARAM_call_cmp_func);
}
...
pub fn sk_X509_VERIFY_PARAM_sort(arg_sk: ?*struct_stack_st_X509_VERIFY_PARAM) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_X509_VERIFY_PARAM_call_cmp_func);
}
...
pub fn sk_X509_VERIFY_PARAM_deep_copy(arg_sk: ?*const struct_stack_st_X509_VERIFY_PARAM, arg_copy_func: sk_X509_VERIFY_PARAM_copy_func, arg_free_func: sk_X509_VERIFY_PARAM_free_func) callconv(.c) ?*struct_stack_st_X509_VERIFY_PARAM {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_X509_VERIFY_PARAM, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_X509_VERIFY_PARAM_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_X509_VERIFY_PARAM_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_SSL_CIPHER_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_SSL_CIPHER_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as(?*const SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(ptr)));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@constCast(@volatileCast(@as(sk_SSL_CIPHER_copy_func, @ptrCast(@alignCast(copy_func))).?(@as(?*const SSL_CIPHER, @ptrCast(ptr)))))));
}
pub fn sk_SSL_CIPHER_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: ?*const SSL_CIPHER = @as(?*const SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(a.*));
    var b_ptr: ?*const SSL_CIPHER = @as(?*const SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(b.*));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_SSL_CIPHER_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_SSL_CIPHER_new(arg_comp: sk_SSL_CIPHER_cmp_func) callconv(.c) ?*struct_stack_st_SSL_CIPHER {
    const comp = arg_comp;
    return @as(?*struct_stack_st_SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_SSL_CIPHER_value(arg_sk: ?*const struct_stack_st_SSL_CIPHER, arg_i: usize) callconv(.c) ?*const SSL_CIPHER {
    const sk = arg_sk;
    const i = arg_i;
    return @as(?*const SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i)));
}
pub fn sk_SSL_CIPHER_set(arg_sk: ?*struct_stack_st_SSL_CIPHER, arg_i: usize, arg_p: ?*const SSL_CIPHER) callconv(.c) ?*const SSL_CIPHER {
    ...
    const p = arg_p;
    return @as(?*const SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_set(@as([*c]_STACK, @ptrCast(@alignCast(sk))), i, @as(?*anyopaque, @ptrCast(@constCast(@volatileCast(p)))))));
}
...
pub fn sk_SSL_CIPHER_pop_free(arg_sk: ?*struct_stack_st_SSL_CIPHER, arg_free_func: sk_SSL_CIPHER_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SSL_CIPHER_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
pub fn sk_SSL_CIPHER_insert(arg_sk: ?*struct_stack_st_SSL_CIPHER, arg_p: ?*const SSL_CIPHER, arg_where: usize) callconv(.c) usize {
    ...
    return sk_insert(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@constCast(@volatileCast(p)))), where);
}
...
pub fn sk_SSL_CIPHER_find(arg_sk: ?*const struct_stack_st_SSL_CIPHER, arg_out_index: [*c]usize, arg_p: ?*const SSL_CIPHER) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_SSL_CIPHER_call_cmp_func);
}
...
pub fn sk_SSL_CIPHER_push(arg_sk: ?*struct_stack_st_SSL_CIPHER, arg_p: ?*const SSL_CIPHER) callconv(.c) usize {
    ...
    return sk_push(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@constCast(@volatileCast(p)))));
}
...
pub fn sk_SSL_CIPHER_sort(arg_sk: ?*struct_stack_st_SSL_CIPHER) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SSL_CIPHER_call_cmp_func);
}
...
pub fn sk_SSL_CIPHER_deep_copy(arg_sk: ?*const struct_stack_st_SSL_CIPHER, arg_copy_func: sk_SSL_CIPHER_copy_func, arg_free_func: sk_SSL_CIPHER_free_func) callconv(.c) ?*struct_stack_st_SSL_CIPHER {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_SSL_CIPHER, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_SSL_CIPHER_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_SSL_CIPHER_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_SRTP_PROTECTION_PROFILE_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]const SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@constCast(@volatileCast(@as(sk_SRTP_PROTECTION_PROFILE_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]const SRTP_PROTECTION_PROFILE, @ptrCast(@alignCast(ptr))))))));
}
pub fn sk_SRTP_PROTECTION_PROFILE_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const SRTP_PROTECTION_PROFILE = @as([*c]const SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const SRTP_PROTECTION_PROFILE = @as([*c]const SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_SRTP_PROTECTION_PROFILE_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_SRTP_PROTECTION_PROFILE_new(arg_comp: sk_SRTP_PROTECTION_PROFILE_cmp_func) callconv(.c) ?*struct_stack_st_SRTP_PROTECTION_PROFILE {
    const comp = arg_comp;
    return @as(?*struct_stack_st_SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_value(arg_sk: ?*const struct_stack_st_SRTP_PROTECTION_PROFILE, arg_i: usize) callconv(.c) [*c]const SRTP_PROTECTION_PROFILE {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]const SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
pub fn sk_SRTP_PROTECTION_PROFILE_set(arg_sk: ?*struct_stack_st_SRTP_PROTECTION_PROFILE, arg_i: usize, arg_p: [*c]const SRTP_PROTECTION_PROFILE) callconv(.c) [*c]const SRTP_PROTECTION_PROFILE {
    ...
    const p = arg_p;
    return @as([*c]const SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_set(@as([*c]_STACK, @ptrCast(@alignCast(sk))), i, @as(?*anyopaque, @ptrCast(@constCast(@volatileCast(p))))))));
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_pop_free(arg_sk: ?*struct_stack_st_SRTP_PROTECTION_PROFILE, arg_free_func: sk_SRTP_PROTECTION_PROFILE_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SRTP_PROTECTION_PROFILE_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_find(arg_sk: ?*const struct_stack_st_SRTP_PROTECTION_PROFILE, arg_out_index: [*c]usize, arg_p: [*c]const SRTP_PROTECTION_PROFILE) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_SRTP_PROTECTION_PROFILE_call_cmp_func);
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_sort(arg_sk: ?*struct_stack_st_SRTP_PROTECTION_PROFILE) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SRTP_PROTECTION_PROFILE_call_cmp_func);
}
...
pub fn sk_SRTP_PROTECTION_PROFILE_deep_copy(arg_sk: ?*const struct_stack_st_SRTP_PROTECTION_PROFILE, arg_copy_func: sk_SRTP_PROTECTION_PROFILE_copy_func, arg_free_func: sk_SRTP_PROTECTION_PROFILE_free_func) callconv(.c) ?*struct_stack_st_SRTP_PROTECTION_PROFILE {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_SRTP_PROTECTION_PROFILE, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_SRTP_PROTECTION_PROFILE_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_SRTP_PROTECTION_PROFILE_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
pub fn sk_SSL_COMP_call_free_func(arg_free_func: OPENSSL_sk_free_func, arg_ptr: ?*anyopaque) callconv(.c) void {
    ...
    const ptr = arg_ptr;
// safe-transpile: optional unwrap requires manual review
    @as(sk_SSL_COMP_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))).?(@as([*c]SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(ptr))));
}
...
// safe-transpile: optional unwrap requires manual review
    return @as(?*anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@as(sk_SSL_COMP_copy_func, @ptrCast(@alignCast(copy_func))).?(@as([*c]SSL_COMP, @ptrCast(@alignCast(ptr))))));
}
pub fn sk_SSL_COMP_call_cmp_func(arg_cmp_func: OPENSSL_sk_cmp_func, arg_a: [*c]const ?*const anyopaque, arg_b: [*c]const ?*const anyopaque) callconv(.c) c_int {
    ...
    const a = arg_a;
    const b = arg_b;
    var a_ptr: [*c]const SSL_COMP = @as([*c]const SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(a.*)));
    var b_ptr: [*c]const SSL_COMP = @as([*c]const SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(b.*)));
// safe-transpile: optional unwrap requires manual review
    return @as(sk_SSL_COMP_cmp_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(cmp_func))).?(&a_ptr, &b_ptr);
}
pub fn sk_SSL_COMP_new(arg_comp: sk_SSL_COMP_cmp_func) callconv(.c) ?*struct_stack_st_SSL_COMP {
    const comp = arg_comp;
    return @as(?*struct_stack_st_SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_new(@as(OPENSSL_sk_cmp_func, @ptrCast(@alignCast(comp))))));
}
...
pub fn sk_SSL_COMP_value(arg_sk: ?*const struct_stack_st_SSL_COMP, arg_i: usize) callconv(.c) [*c]SSL_COMP {
    const sk = arg_sk;
    const i = arg_i;
    return @as([*c]SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk_value(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), i))));
}
...
pub fn sk_SSL_COMP_pop_free(arg_sk: ?*struct_stack_st_SSL_COMP, arg_free_func: sk_SSL_COMP_free_func) callconv(.c) void {
    ...
    const free_func = arg_free_func;
    sk_pop_free_ex(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SSL_COMP_call_free_func, @as(OPENSSL_sk_free_func, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(free_func))));
}
...
pub fn sk_SSL_COMP_find(arg_sk: ?*const struct_stack_st_SSL_COMP, arg_out_index: [*c]usize, arg_p: [*c]const SSL_COMP) callconv(.c) c_int {
    ...
    return sk_find(@as([*c]const _STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), out_index, @as(?*const anyopaque, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(p)), &sk_SSL_COMP_call_cmp_func);
}
...
pub fn sk_SSL_COMP_sort(arg_sk: ?*struct_stack_st_SSL_COMP) callconv(.c) void {
    const sk = arg_sk;
    sk_sort(@as([*c]_STACK, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(@alignCast(sk))), &sk_SSL_COMP_call_cmp_func);
}
...
pub fn sk_SSL_COMP_deep_copy(arg_sk: ?*const struct_stack_st_SSL_COMP, arg_copy_func: sk_SSL_COMP_copy_func, arg_free_func: sk_SSL_COMP_free_func) callconv(.c) ?*struct_stack_st_SSL_COMP {
    ...
    const free_func = arg_free_func;
    return @as(?*struct_stack_st_SSL_COMP, // safe-transpile: @ptrCast requires manual review — add @alignCast if alignment is guaranteed
    @ptrCast(sk_deep_copy(@as([*c]const _STACK, @ptrCast(@alignCast(sk))), &sk_SSL_COMP_call_copy_func, @as(OPENSSL_sk_copy_func, @ptrCast(@alignCast(copy_func))), &sk_SSL_COMP_call_free_func, @as(OPENSSL_sk_free_func, @ptrCast(@alignCast(free_func))))));
}
...
// safe-transpile: @intCast requires manual review — consider safe.CheckedInt(T).init(@intCast)
    ...
    pub fn configureHTTPClientWithALPN(ssl: *SSL, hostname: [:0]const u8, offer: AlpnOffer) void {
        ...
        const alpns: safe.Slice(u8) = switch (offer) {
            .h1 => alpn_h1,
            .h1_or_h2 => alpn_h2_h1,
            .h2_only => alpn_h2,
        };
        ...
        return switch (SSL_get_error(this, rc)) {
            SSL_ERROR_SSL => {
                if (comptime Environment.isDebug) {
                    const errdescription = std.mem.span(if (SSL_error_description(SSL_ERROR_SSL)) |value| {
    value
} else {
