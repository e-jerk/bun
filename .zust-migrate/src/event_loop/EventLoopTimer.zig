...
pub fn fire(self: *Self, now: *const timespec, vm: *VirtualMachine) void {
    switch (self.tag) {
        .PostgresSQLConnectionTimeout => @as(*api.Postgres.PostgresSQLConnection, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("timer", self))).onConnectionTimeout(),
        .PostgresSQLConnectionMaxLifetime => @as(*api.Postgres.PostgresSQLConnection, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("max_lifetime_timer", self))).onMaxLifetimeTimeout(),
        .MySQLConnectionTimeout => @as(*api.MySQL.MySQLConnection, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("timer", self))).onConnectionTimeout(),
        .MySQLConnectionMaxLifetime => @as(*api.MySQL.MySQLConnection, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("max_lifetime_timer", self))).onMaxLifetimeTimeout(),
        .ValkeyConnectionTimeout => @as(*api.Valkey, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("timer", self))).onConnectionTimeout(),
        .ValkeyConnectionReconnect => @as(*api.Valkey, // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("reconnect_timer", self))).onReconnectTimer(),
        ...
        inline else => |t| {
            ...
            var container: *t.Type() = // safe-transpile: @alignCast requires manual review
    @alignCast(@fieldParentPtr("event_loop_timer", self));
